 ...
 */
registerCustomVerification("verifyYearExtracted", (state: BrowserState, _history: BrowserState[]) => {
 ...
 */
registerCustomVerification("verifyCreatorExtracted", (state: BrowserState, _history: BrowserState[]) => {
 ...
 */
registerCustomVerification("verifyVersionExtracted", (state: BrowserState, _history: BrowserState[]) => {

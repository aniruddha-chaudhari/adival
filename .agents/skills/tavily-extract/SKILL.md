---
name: tavily-extract
description: "Targeted URL extraction with Tavily. Use when the user provides specific page URLs and wants clean markdown/text (including JS-rendered pages)."
